...
import com.wanderwildwood.einkmusic.data.PlaylistManager
import com.wanderwildwood.einkmusic.data.PlaylistTrackEntity
    ...
    suspend fun createOrUpdatePlaylist(params: EditPlaylistParams): EditPlaylistResult {
        return withContext(Dispatchers.IO) {
            ...
            if (params.playlistId != null) {
                ...
                val entity = com.wanderwildwood.einkmusic.data.PlaylistEntity(
                    id = playlistId,
                    name = params.name,
                    description = params.description,
                )
